/*
earth images from epic.gsfc.nasa.gov
*/
...
function get_earth_image() {
    /*
    Natural-spectrum Earth images from EPIC are delayed by a few days.
    Find the most recent data, then pick the images that's
    nearest to the current time-of-day.
    */
